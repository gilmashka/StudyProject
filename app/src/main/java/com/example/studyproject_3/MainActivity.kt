...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val title = intent.getStringExtra(getString(R.string.notification_title_key))
        val message = intent.getStringExtra(getString(R.string.notification_message_key))
    ...
    Scaffold(
        bottomBar = {
            NavigationBar {
                ...
                NavigationBarItem(
                    icon = { },
                    label = { Text(stringResource(R.string.edit_tab)) },
